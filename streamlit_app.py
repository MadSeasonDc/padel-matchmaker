...
# ----------------------------
# JORNADAS (PASO 1: SINCRONIZAR UI CON DATOS)
# ----------------------------
if menu == "Jornadas":
    import datetime
    ...
    # Crear 4 partidos solo la primera vez
    if len(jornada["partidos"]) == 0 and all(len(j["partidos"]) == 0 for j in data["jornadas"]):
        for _ in range(4):
