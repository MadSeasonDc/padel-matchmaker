            ...
            with cols[col_idx]:
                with st.container(border=True):
                    ...
                    with col_p1:
                        ...
                        partido["pareja_1"] = [
                            st.selectbox("Der", [""] + jugadores, key=f"p1d_{idx}"),
                            st.selectbox("Rev", [""] + jugadores, key=f"p1r_{idx}")
                        ]

                    with col_p2:
                        st.markdown("**Pareja 2**")
                        partido["pareja_2"] = [
                            st.selectbox("Der", [""] + jugadores, key=f"p2d_{idx}"),
                            st.selectbox("Rev", [""] + jugadores, key=f"p2r_{idx}")
                        ]
